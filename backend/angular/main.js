...
var AnnotationComponent = /** @class */ (function () {
    ...
    AnnotationComponent.prototype.createFormAnnotation = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            annotationInput: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null, {
                validators: [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(5),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(450)
    ...
    */
    AnnotationComponent.prototype.getCaretCharacterOffsetWithin = function (element) {
        var caretOffset = 0;
    ...
    AnnotationComponent.prototype.highlightSelection = function () {
        ...
        if (userSelection.toString() === null || userSelection.toString().trim() == "") {
            ...
            var startOffset = this.getCaretCharacterOffsetWithin(this.docManager.element) - userSelection.toString().length; ///CHANGE, string length may not be selection size sometimes causes error, look into this
            ...
            this.docService.lookupDef(this.CTpair).then(function (rslt) {
                console.log(rslt);
                _this.description = rslt;
                _this.openAnnotationBox('annotationModal');
            });
    ...
    AnnotationComponent.prototype.addToDoc2 = function () {
        var _this = this;
    ...
    AnnotationComponent.prototype.setAnnotationInput = function (a_input) {
    ...
    AnnotationComponent.prototype.openAnnotationBox = function (box) {
...
var DocService = /** @class */ (function () {
    ...
    DocService.prototype.lookupDef = function (ct) {
        var _this = this;
